...
smoke:
	...
	PYTHONPATH=src python3 -m agent_command_receipt verify /tmp/agent-command-receipt.json --base-dir . >/tmp/agent-command-receipt-verify.md
	PYTHONPATH=src python3 -m agent_command_receipt verify examples/passing-receipt.json >/tmp/agent-command-receipt-example.md
